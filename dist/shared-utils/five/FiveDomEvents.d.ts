...
type Object3DWithEvent = THREE.Object3D & {
    _domEvent?: {
        [key in `${EventName | 'wantDblclick'}Handler`]?: Array<[FiveDomEventMap[EventName], EventHandlerConfig]>;
    };
    _hovered?: boolean;
    _dragging?: boolean;
    draggable?: boolean;
...
export declare class FiveDomEvents {
     ...
     */
    addAutoBindEventListener<T extends EventName = EventName>(object: Object3DWithEvent, event: T, callback: FiveDomEventMap[T], config?: EventHandlerConfig): () => void;
    /**
