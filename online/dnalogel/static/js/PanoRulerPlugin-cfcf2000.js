import{b as ae,c as ie,w as Z}from"./mockData-c3335b2d.js";import{V as O,F as le,a8 as ce,r as U,b as ue,a as de,a9 as fe,j as $,B as me,aa as he,ax as ye,c as pe,d as be,p as ge,e as xe,R as we}from"./vendor-53caf517.js";import"./constants-7fa3ac35.js";import{t as Fe}from"./throttle-19b08aa2.js";function ee(e,t){return e.x===t.x&&e.y===t.y}function ne(e,t){return Math.abs(e)===1/0&&Math.abs(t)===1/0?!0:Math.abs(e-t)<.001}function B(e,t){return(t.y-e.y)/(t.x-e.x)}function Me(e,t,n){const r=B(e[1],e[0]),i=B(t[1],t[0]);if(isNaN(r)||isNaN(i)||ne(r,i))return!1;if(Y(e[0],t))return e[0];if(Y(e[1],t))return e[1];if(Y(t[0],e))return t[0];if(Y(t[1],e))return t[1];if(n&&!ve(e,t))return!1;const p=e[0],s=t[0];if(Math.abs(r)===1/0)return{x:p.x,y:t[1].y-(t[1].x-p.x)*i};if(Math.abs(i)===1/0)return{x:s.x,y:e[1].y-(e[1].x-s.x)*r};const c=(s.y-p.y+r*p.x-i*s.x)/(r-i),I=r*c-r*p.x+p.y;return{x:c,y:I}}function Y(e,t){return ee(e,t[0])||ee(e,t[1])?!0:(t[0].x-e.x)*(e.x-t[1].x)>=0&&(t[0].y-e.y)*(e.y-t[1].y)>=0&&ne(B(t[0],e),B(e,t[1]))}function H(e,t,n){return(e.x-n.x)*(t.y-n.y)-(t.x-n.x)*(e.y-n.y)}function ve(e,t){return Math.max(e[0].x,e[1].x)>=Math.min(t[0].x,t[1].x)&&Math.max(t[0].x,t[1].x)>=Math.min(e[0].x,e[1].x)&&Math.max(e[0].y,e[1].y)>=Math.min(t[0].y,t[1].y)&&H(t[0],e[1],e[0])*H(e[1],t[1],e[0])>0&&H(e[0],t[1],t[0])*H(t[1],e[1],t[0])>0?1:0}function oe(e,t=0){t<=0?requestAnimationFrame(e):requestAnimationFrame(()=>oe(e,t-1))}const Re=`<style type="text/css">
