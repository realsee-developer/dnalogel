...
class wi extends n {
  constructor(i) {
    ...
    const s = (m = (r = i.position) != null ? r : this.model.center) != null ? m : v(this.model).getCenter(new l.Vector3());
    this.tag = a(this.five, s, { wrapper: i.tagWrapper }), this.tag.extraObjectsForIntersectCheck.push(this.group);
  }
  get container() {
  ...
  updateVisible() {
    !this.visibles.some((s) => s === !1) ? (this.tag.show(), this.model.visible = !0) : (this.tag.hide(), this.model.visible = !1), this.five.needsRender = !0;
  }
  onClick() {
