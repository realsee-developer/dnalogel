...
class Di extends n {
  constructor(i) {
    ...
    const r = (m = (s = i.position) != null ? s : this.model.center) != null ? m : v(this.model).getCenter(new l.Vector3());
    this.tag = a(this.five, r, { wrapper: i.tagWrapper }), this.tag.extraObjectsForIntersectCheck.push(this.group);
  }
  get container() {
