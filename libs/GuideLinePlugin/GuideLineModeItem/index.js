...
class N {
  ...
  setTag(e, t) {
    ...
    if (!(t != null && t.data))
      return;
    const r = e === "start" ? (g = this.startTagContainer) != null ? g : (() => (this.startTagContainer = { tag: null, plugin: new k(this.five, { containerZIndex: 1 }) }, this.startTagContainer))() : (c = this.endTagContainer) != null ? c : (() => (this.endTagContainer = { tag: null, plugin: new k(this.five, { containerZIndex: 1 }) }, this.endTagContainer))(), o = B({}, {
      contentType: "Custom",
      stickType: "2DPoint",
