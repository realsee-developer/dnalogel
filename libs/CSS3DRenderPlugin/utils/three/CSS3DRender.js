...
class y {
  ...
  constructor(e) {
    ...
    n(this, "create3DElement", (e, t, r) => {
      ...
      const { ratio: u, devicePixelRatio: m, mode: c, autoRender: p, container: O, pointerEvents: F, wrapperStyle: I } = s;
      let b = !1;
      const a = this.createObject(d, { ratio: u, dpr: m, container: O, mode: c, pointerEvents: F, wrapperStyle: I });
