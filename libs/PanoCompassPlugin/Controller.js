...
var d = (h, n, e) => new Promise((t, o) => {
  ...
  }, l = (p) => p.done ? t(p.value) : Promise.resolve(p.value).then(s, i);
  l((e = e.apply(h, n)).next());
});
...
class de extends A {
  constructor(e, t) {
    ...
    r(this, "onFivePanoArrived", (e) => {
      ...
      if (this.compassMesh && t && (this.compassMesh.position.copy(t.clone().setY(t.y + 0.01)), this.compassMesh.material.opacity === 0 && ((l = this.compassMeshTween) == null || l.dispose(), this.compassMeshTween = D(1e3).onUpdate(({ progress: v }) => {
        var m;
  ...
  init() {
    return d(this, null, function* () {
      ...
      const t = (l = (i = this.data) == null ? void 0 : i.entrance) != null ? l : null;
