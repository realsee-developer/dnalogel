...
var g = (h, n, e) => n in h ? P(h, n, { enumerable: !0, configurable: !0, writable: !0, value: e }) : h[n] = e, f = (h, n) => {
  for (var e in n || (n = {}))
    _.call(n, e) && g(h, e, n[e]);
  if (D)
    for (var e of D(n))
      A.call(n, e) && g(h, e, n[e]);
  return h;
};
var r = (h, n, e) => (g(h, typeof n != "symbol" ? n + "" : n, e), e);
...
import { getRoomInfoInstance as T } from "./getRoomInfoInstance.js";
...
import { tweenProgress as b } from "../shared-utils/animationFrame/BetterTween.js";
import { PANO_COMPASS_DEFAULT_IMAGE as U, ENTRY_DOOR_DEFAULT_IMAGE as E } from "../shared-utils/url/defaultUrls.js";
...
class ot extends F {
  constructor(e, t) {
    ...
    r(this, "onFivePanoArrived", (e) => {
      ...
      if (this.compassMesh && t && (this.compassMesh.position.copy(t.clone().setY(t.y + 0.01)), this.compassMesh.material.opacity === 0 && ((m = this.compassMeshTween) == null || m.dispose(), this.compassMeshTween = b(1e3).onUpdate(({ progress: v }) => {
        var l;
        (l = this.compassMesh) == null || l.material.setValues({ opacity: v }), this.five.needsRender = !0;
      }).play())), this.logoMesh && t && (this.logoMesh.position.copy(t.clone().setY(t.y + 0.011)), this.logoMesh.material.opacity === 0 && ((p = this.logoMeshTween) == null || p.dispose(), this.logoMeshTween = b(1e3).onUpdate(({ progress: v }) => {
        var l;
  ...
  loadLogoMesh() {
    return d(this, null, function* () {
      if (!this.state.config.logoURL)
        return;
      const e = this.state.config.logoURL, t = yield u(e);
  ...
  loadEntryDoorMesh() {
    return d(this, null, function* () {
      const e = this.state.config.entryDoorImageUrl, t = yield u(e), o = new a.PlaneGeometry(0.2, 0.16), s = new a.MeshBasicMaterial({
        map: t,
        transparent: !0,
        opacity: 0.8,
        depthTest: !1
