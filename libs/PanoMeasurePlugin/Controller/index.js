...
var f = (n, s, t) => s in n ? D(n, s, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[s] = t, p = (n, s) => {
  for (var t in s || (s = {}))
...
class ni extends J {
  constructor(t, e) {
    ...
    o(this, "disable", () => {
      var t, e, i, r;
      this.hasOpen = !1, this.state.enabled = !1, this.container.style.visibility = "hidden", this.container.style.opacity = "0", (t = this.controller) == null || t.dispose(), (e = this.useUIController) == null || e.hide(), (i = this.useGuideController) == null || i.hide(), (r = this.shortcutKeyController) == null || r.dispose(), this.controller = null, this.five.helperVisible = !0, this.five.scene.remove(this.group), this.five.needsRender = !0, this.hook.emit("disable", !0);
    });
    o(this, "getCurrentMode", () => this.controller instanceof c ? "Edit" : this.controller instanceof T ? "Watch" : this.controller instanceof u ? "Mixed" : this.controller instanceof k ? "View" : null);
    /** 变更场景
    ...
    o(this, "changeMode", (t) => {
      ...
      this.controller = new e[t](i), t === "View" ? ((l = this.useUIController) == null || l.hide(), (h = this.useGuideController) == null || h.hide()) : ((m = this.useUIController) == null || m.show(), (a = this.useGuideController) == null || a.show()), this.hook.emit("modeChange", t);
    });
    /**
     * @description: 切换测量的类型
     */
    ...
    this.five = t, this.hook = this.hooks, this.params = e, this.config = O(e, ["openParams", "magnifierParams"]), this.model = new W(this.config), this.isMobile = (h = (l = e == null ? void 0 : e.openParams) == null ? void 0 : l.isMobile) != null ? h : !1, this.magnifier = new j(
      t,
      (y = (g = e.magnifierParams) != null ? g : (a = (m = e.pointSelectorConfig) == null ? void 0 : m.helper) == null ? void 0 : a.magnifierParams) != null ? y : { width: 190, height: 190, scale: 2 }
    ...
    const i = (v = (P = e.editParams) == null ? void 0 : P.pointSelectorMode) != null ? v : F ? "fixed" : "cursor", r = (b = this.params.openParams) != null ? b : {};
    ...
    if (this.params.useGuideController !== !1) {
      const d = p({
        ...
        pointSelectorMode: i,
        i18n: e.i18n
      }, x(this.params.useGuideController));
  ...
  load(t) {
    let e = t;
    t.list && (e = {
      polylines: t.list.map((r) => r.polyline).map((r) => {
        var l;
        return U(p({}, r), {
          visibleFiveMode: (l = r.visibleFiveMode) != null ? l : ["Panorama"]
        });
      })
  ...
  save(t) {
    ...
    if (!(this.controller instanceof c) && !(this.controller instanceof u))
      return this;
    const e = (r = t == null ? void 0 : t.mode) != null ? r : "View", i = this.controller.model.areas;
    return this.controller instanceof c ? this.controller.complete() : i.forEach((l) => {
  ...
  setCustomText(t, e) {
    ...
    i.setText(e), (r = this.controller) == null || r.updateDistanceUI();
  }
  createControllerParams() {
    var i, r;
    const t = (i = this.params.openParams) != null ? i : {}, e = (r = this.params.editParams) != null ? r : {};
