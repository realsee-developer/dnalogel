...
var c = (n, s, t) => s in n ? x(n, s, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[s] = t, a = (n, s) => {
  for (var t in s || (s = {}))
...
import m from "./MixedController.js";
...
class ii extends H {
  constructor(t, e) {
    ...
    r(this, "getCurrentMode", () => this.controller instanceof h ? "Edit" : this.controller instanceof T ? "Watch" : this.controller instanceof m ? "Mixed" : this.controller instanceof k ? "View" : null);
    /** 变更场景
  ...
  save(t) {
    var o;
    if (!(this.controller instanceof h) && !(this.controller instanceof m))
      return this;
  ...
  /** Mixed 模式才有用，添加起点 */
  addStartPoint() {
    this.controller instanceof m && this.hook.emit("willChangeState", "watching", "editing");
  }
  /** Mixed 模式才有用，添加终点 */
  addEndPoint() {
    this.controller instanceof m && this.hook.emit("willChangeState", "editing", "watching");
  }
  /** 导出数据 */
  toJson() {
  ...
  createControllerParams() {
    ...
    return t.isMobile = this.isMobile, {
      ...
      mouseGroup: O(a({}, t.crossHairParameter)),
