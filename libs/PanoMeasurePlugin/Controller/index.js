...
class hi extends J {
  constructor(t, e) {
    ...
    o(this, "changeMode", (t) => {
      ...
      this.controller = new e[t](r), t === "View" ? ((l = this.useUIController) == null || l.hide(), (h = this.useGuideController) == null || h.hide()) : ((m = this.useUIController) == null || m.show(), (a = this.useGuideController) == null || a.show()), this.hook.emit("modeChange", t);
    });
    /**
     * @description: 切换测量的类型
     */
