...
class Xt {
  constructor(t, e) {
    ...
    }), this.domContainer = e.domContainer || null, this.meshContainer = e.meshContainer || null, this.five = e.five || null, this.areaItem.appendTo(this.domContainer), (r = this.five) == null || r.on("cameraUpdate", this.updateDom);
  }
  /**
  ...
  addPoints(t) {
    ...
    const e = this.points.at(-2), r = this.points.at(-1);
    if (e && r) {
      const p = new u(new n(e), new n(r), this.polyline.model);
