...
function O(n) {
  ...
  return {
    c() {
      o = h("div"), i = h("div"), t = h("div"), f = C(), d = y(p), v = C(), m = h("div"), a = h("div"), b = C(), r = y(c), g(t, "class", "icon svelte-468fdd"), E(t, "background-image", `url(${ee})`), g(i, "class", "button svelte-468fdd"), z(i, "forbid", !/*canRevoke*/
    ...
    m(u, e) {
      R(u, o, e), s(o, i), s(i, t), s(i, f), s(i, d), s(o, v), s(o, m), s(m, a), s(m, b), s(m, r), l || (_ = [
        S(
          i,
          "click",
          /*click_handler*/
...
function ie(n) {
  ...
  return (
    ...
    n[4]), a = new Y({ props: u }), G.push(() => H(a, "setIndex", _)), {
      c() {
        o = h("div"), r && r.c(), i = C(), t = h("div"), f = h("div"), p = C(), d = h("div"), l && l.c(), v = C(), m = h("div"), P(a.$$.fragment), g(f, "class", "mask svelte-468fdd"), g(m, "class", "mode-switcher svelte-468fdd"), g(d, "class", "center svelte-468fdd"), g(t, "class", "bottom svelte-468fdd"), g(o, "class", "Measure-Controller svelte-468fdd");
      },
      m(e, k) {
        R(e, o, k), r && r.m(o, null), s(o, i), s(o, t), s(t, f), s(t, p), s(t, d), l && l.m(d, null), s(d, v), s(d, m), T(a, m, null), c = !0;
      },
      p(e, [k]) {
        /*showExit*/
