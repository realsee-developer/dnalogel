...
var m = (e, l, t) => l in e ? M(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, r = (e, l) => {
  for (var t in l || (l = {}))
    g.call(l, t) && m(e, t, l[t]);
  if (a)
    for (var t of a(l))
      f.call(l, t) && m(e, t, l[t]);
  return e;
}, c = (e, l) => E(e, b(l));
var S = (e, l) => {
  var t = {};
...
var h = (e, l, t) => (m(e, typeof l != "symbol" ? l + "" : l, t), t);
...
class P extends D {
  constructor(t) {
    ...
    this.withDots = i != null ? i : !0, s && this.setPoints(s), o && this.setStyle(o), this.addEventListener("removed", () => {
      C(this);
    });
  }
  get style() {
  ...
  setPoints(t, i = { closed: !1 }) {
    ...
    i.closed && (s = w(s)), s.forEach((o, n) => {
      ...
      u.setStyle(this.style), u.setPoints([o, p]);
