...
var m = (r, t, e) => t in r ? u(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e, l = (r, t) => {
  for (var e in t || (t = {}))
    c.call(t, e) && m(r, e, t[e]);
  if (f)
    for (var e of f(t))
...
class z extends _ {
  ...
  updateAreaItems() {
    ...
    o === "0.00" ? this.areaDom.container.innerHTML = "" : this.areaDom.container.innerHTML = w(o + "m²", {
      style: `color: #${M((h = this.style) == null ? void 0 : h.color) ? new a.Color(this.style.color).getHexString() : "000000"}`
    });
  }
}
export {
