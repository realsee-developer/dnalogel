...
var p = (h, n, e) => n in h ? _(h, n, { enumerable: !0, configurable: !0, writable: !0, value: e }) : h[n] = e, f = (h, n) => {
  for (var e in n || (n = {}))
    E.call(n, e) && p(h, e, n[e]);
  if (T)
    for (var e of T(n))
      v.call(n, e) && p(h, e, n[e]);
  return h;
}, g = (h, n) => w(h, b(n));
var r = (h, n, e) => (p(h, typeof n != "symbol" ? n + "" : n, e), e);
import * as y from "three";
import { DEFAULT_LINE_COLOR as D, DEFAULT_LINE_WIDTH as I, DEFAULT_HIGHLIGHT_OPACITY as O } from "../typings/style.js";
...
import { LightTag as H } from "../../shared-utils/tag.js";
...
class ne extends C {
  ...
  highlight() {
    this.highlighted || (this.highlighted = !0, this.opacityBeforeHighlight = this.line1.material.opacity, this.line1.material.opacity = this.opacityBeforeHighlight * O, this.line2.material.opacity = this.line1.material.opacity, this.needsRender = !0);
  }
  unhighlight() {
  ...
  updateDomItems() {
    ...
    i.forEach(([t, s], l) => {
      ...
      this.doms[l] = (d = this.doms[l]) != null ? d : (() => {
        const o = new H(this.five);
        return o.intersectCheck = !1, o.simulate3D = !0, o;
      })(), this.doms[l].setPosition(c, [t, s]);
      const a = (o) => {
        var u;
        this.doms[l].__text !== o && (this.doms[l].__text = o, o ? this.doms[l].container.innerHTML = P(o, {
