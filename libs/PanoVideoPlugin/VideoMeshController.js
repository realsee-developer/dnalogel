...
import { anime as D } from "../vendor/animejs/lib/anime.es.js";
...
class $i {
  ...
  constructor(i, e) {
    ...
    t(this, "onVideoPlayingAndLoaded", () => {
      ...
      this.video.addEventListener(
        "timeupdate",
        () => {
          if (this.enabled && this.panoIndex === this.five.getCurrentState().panoIndex && this.five.getCurrentState().mode === "Panorama" && (this.renderFiveDisposer || (this.renderFiveDisposer = b(() => {
  ...
  lookAtVideo() {
    ...
    if (!e)
      return;
    const n = new p().subVectors(e, this.observer.position).normalize(), { longitude: o, latitude: r } = A(n);
