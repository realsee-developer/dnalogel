...
var f = (a, l, t) => (L(a, typeof l != "symbol" ? l + "" : l, t), t);
...
class ui extends Y {
  constructor(t) {
    ...
    f(this, "container");
    f(this, "MinVisibledistance", 1.8);
    f(this, "MaxVisibledistance", 5);
    f(this, "OffsetHeight", -1.3);
    // 标签页面高度偏移值
    f(this, "floorplanServerData");
    /** 每个点位 visible 标签的缓存 */
    f(this, "visibleLabelMap", /* @__PURE__ */ new Map());
    /** 标签项Prop值 */
    f(this, "labelItems", []);
    /** 数据 */
    f(this, "doorLabels");
    f(this, "roomObservers");
    f(this, "loadData", (t, i) => {
    ...
    f(this, "initRoomObservers", () => {
      ...
      const t = this.floorplanServerData.computed_data.floor_datas || [], r = (((n = (o = this.five) == null ? void 0 : o.work) == null ? void 0 : n.observers) || []).map((s) => {
        const e = s.panoIndex, b = s.floorIndex, c = t == null ? void 0 : t.find((h) => h.floor_index === b);
        if (c) {
          const h = c.rooms.find((m) => m.observer_indexs.includes(e));
          if (h)
            return { panoIndex: e, floorIndex: b, name: h.name };
        }
      }).filter(Boolean);
      this.roomObservers = r;
    });
    f(this, "hideAllLabels", () => {
      this.labelItems.forEach((t) => {
        t.visible = !1, t.inSight = !1;
      });
    });
    f(this, "fixDoorVisibleAndPosition", () => {
      ...
      const i = this.roomObservers.find((s) => s.panoIndex === t), o = this.five.work.observers.find((s) => s.panoIndex === t).position.clone(), n = (() => {
        ...
        {
          const s = [];
          return this.doorLabels.forEach((e, b) => {
            ...
            m.set(o, d);
            const [v] = this.five.model.intersectRaycaster(m);
            v && v.distance + 0.1 < h || s.push(b);
    ...
    f(this, "fixDoorPosition", () => {
      ...
      if (this.labelItems.forEach((p, u) => {
        var I;
        if (p.visible) {
          const g = i.position.distanceTo(p.position), S = p.position.clone().add(new A(0, this.OffsetHeight, 0)), w = S.clone().sub(i.position).normalize().angleTo(s), y = S.clone().project(i), P = (y.x + 1) / 2.2 * 100, T = (-y.y + 1) / 2.2 * 100, F = P >= 0 && P <= 100 && T >= 0 && T <= 100 && g > this.MinVisibledistance && g <= this.MaxVisibledistance;
          p.left = P, p.top = T, p.inSight = F && w < Math.PI / 2, p.cameraToward = J(this.five), F ? e.push({ disFromCameraToLabel: g, left: P, top: T, index: u }) : p.transform = "translate(-50%, -50%)";
        } else
          p.inSight = !1;
        const M = p, { svelteApp: D } = M, C = B(M, ["svelteApp"]);
        (I = p.svelteApp) == null || I.$set({ props: C });
      }), e.length > 1) {
        let p = 0;
        ...
        for (let u = 1; u < e.length; u++) {
          ...
          const y = {
            left: o * C / 100,
            top: n * M / 100,
            width: (h = (c = (b = V.children) == null ? void 0 : b[0]) == null ? void 0 : c.clientWidth) != null ? h : 0,
            height: (v = (d = (m = V.children) == null ? void 0 : m[0]) == null ? void 0 : d.clientHeight) != null ? v : 0
          }, P = {
            left: o * g / 100,
            top: n * S / 100,
          ...
          K(y, P) && (p++, this.labelItems[D].transform = `translate(-50%, ${(p - 1) * 100 - 50}%)`, this.labelItems[I].transform = `translate(-50%, ${p * 100 - 50}%)`);
        }
      }
    });
    f(this, "onClick", (t, i) => {
    ...
    f(this, "initData", () => {
      ...
      (o = this.floorplanServerData.computed_data.doors) == null || o.forEach((n) => {
        const s = this.five.work.observers.filter((m, d) => {
          var v;
          return !!((v = r == null ? void 0 : r.rooms) != null && v.find((x) => x.observer_indexs.includes(d)));
        }), e = n.position;
        let b = 1 / 0, c;
        s.forEach((m) => {
          const d = m.standingPosition, v = {
            x: d.x,
            y: d.y,
            z: d.z
          }, x = tt(e, v);
...
export {
  ui as PanoDoorLabelPluginController
};
