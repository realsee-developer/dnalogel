...
class Ft extends l {
   ...
   */
  registerRenderer(t, r, e) {
    var m;
    this.rendererMap.set(t, { renderer: r, usePoint: (m = e == null ? void 0 : e.usePoint) != null ? m : !1 });
  }
  bindRenderer(t, r) {
  ...
  clearUnusedPanelTag() {
    ...
    for (const [t, r] of this.store.css3DRenderDisposer) {
      ...
      (!e || e.stickType === "2DPoint") && (r == null || r.forEach((m) => m == null ? void 0 : m()), this.store.css3DRenderDisposer.delete(t));
    }
  }
}
export {
