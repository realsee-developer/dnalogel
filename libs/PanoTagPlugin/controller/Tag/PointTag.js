...
var f = (n, o, t) => o in n ? c(n, o, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[o] = t;
var p = (n, o, t) => (f(n, typeof o != "symbol" ? o + "" : o, t), t);
...
class Ht extends g {
  ...
  unfoldAndFoldOthers() {
    ...
    t && i && (this.state.unfolded = !this.state.unfolded, this.plugin.addRenderQueue({ type: "TagContainerSvelte", keys: ["tags"] }), this.state.unfolded && this.plugin.tags.forEach((s) => {
      s.id !== this.id && s.fold();
    }));
  }
  onClick(t) {
  ...
  setUnfold(t) {
    ...
    i && s && (this.state.unfolded = t, this.hooks.emit(t ? "unfolded" : "folded"), this.plugin.addRenderQueue({ type: "TagContainerSvelte", keys: ["tags"] }));
  }
  setPosition(t) {
  ...
  updateScreenPosition(t) {
    ...
    if (this.stickType !== "2DPoint" && this.stickType !== "3DPoint")
      return;
    const { force: i = !1 } = t != null ? t : {}, s = i ? this.state.visible : this.currentVisible, e = (a = this.__Object__) != null ? a : {
      timeoutId: void 0,
      inAnimation: !1
    };
    if (this.__Object__ = e, !s && this.screenPosition ? (e.inAnimation = !0, e.timeoutId = setTimeout(() => {
    ...
    }, 1e3)) : e.timeoutId && (clearTimeout(e.timeoutId), e.inAnimation = !1, e.timeoutId = void 0), !s && !e.inAnimation)
      return;
    ...
    if (r && this.five.renderer) {
      const m = (() => {
        if (!this.currentConfig.simulate3D)
          return 1;
        const u = 2 * Math.tan(0.5 * this.five.camera.fov / 180 * Math.PI), h = this.getDistance(void 0, 1);
        return Math.max(Math.min(1 - u * h / 40, 1), 0.5);
