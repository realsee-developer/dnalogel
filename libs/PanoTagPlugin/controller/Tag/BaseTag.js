...
import { isPanoramaLike as T, isModelLike as k } from "../../../shared-utils/five/mode.js";
...
class Ri {
  constructor(i, e) {
    ...
    e.config = o, this.id = (d = e.id) != null ? d : le(), this.enabled = (h = e.enabled) != null ? h : !0, this.contentType = e.contentType, this.data = (u = o.initialData) != null && u.important ? b(e.data, r, o.initialData) : b(e.data, o.initialData, r), this.state = g({
      visible: void 0,
      ...
      return Array.isArray(a) && a.length === 4 ? a.map(O).map((p) => L(p, m).toArray()) : L(O(a), m).toArray();
  ...
  getSquaredDistance() {
    ...
    let e;
    return Array.isArray(this.position[0]) ? e = this.position[0] : e = this.position, C(e[0] - i.x, 2) + C(e[1] - i.y, 2) + C(e[2] - i.z, 2);
  }
  getVisible(i) {
    ...
    return (() => {
        ...
        };
      {
        ...
        if (n.followModelVisibility === !0 && ["poincare", "aerophoto", "sand"].includes(this.workUtil.fromType) && (r === "Floorplan" || r === "Mapview")) {
          const h = this.computeVisibleByFloorIndex(), { value: p } = h, v = A(h, ["value"]);
          if (p === !1)
        ...
        if (n.visibleDistance !== void 0 && (s.push("visibleDistance"), n.visibleDistance !== "unLimited")) {
          const p = this.getDistance(e, 1);
          if (x(p, n.visibleDistance) === !1)
            return {
              value: !1,
              checkedList: s,
              panoIndex: t,
              visibleDistance: n.visibleDistance,
              reason: `distance is not in visibleDistance. distance: ${p}, visibleDistance: ${n.visibleDistance.min} - ${n.visibleDistance.max}`
            };
        }
        if (n.intersectRaycaster !== !1 && (typeof n.intersectRaycaster != "object" || n.intersectRaycaster.enabled !== !1)) {
          ...
          const p = this.computeVisibleByIntersect(t);
          if (p.value === !1)
            return Object.assign(p, { checkedList: s });
        }
        return {
          value: !0,
          checkedList: s,
  ...
  computeVisibleByIntersect(i) {
    ...
    for (const a of s) {
      ...
      p = Math.min(p != null ? p : 1 / 0, (h = I == null ? void 0 : I.distance) != null ? h : 1 / 0), p + W >= _ ? l++ : o++;
  ...
  computeUnfoldedByCamera() {
    var e;
    if (this.entryFromModel && k(this.five.state.mode))
      return !1;
