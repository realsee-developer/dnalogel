...
var D = (n, i, t) => new Promise((m, o) => {
  ...
  }, e = (s) => s.done ? m(s.value) : Promise.resolve(s.value).then(a, r);
...
class _e extends A {
  ...
  setData(...i) {
    var m, o, a, r, e;
    super.setData(...i), this.computeRenderType() === "Mesh" ? ((o = (m = this.data.mediaData) == null ? void 0 : m[0]) == null ? void 0 : o.type) === "Video" ? this.renderVideoPlane() : ((r = (a = this.data.mediaData) == null ? void 0 : a[0]) == null ? void 0 : r.type) === "Image" && this.renderImagePlane() : (e = this.tag3DContentSvelte) == null || e.svelteApp.$set({ tag: this });
  }
  loadModel() {
    return D(this, null, function* () {
      var t, m, o, a, r, e;
      if (yield C(this.five), this.computeRenderType() === "Mesh")
        ((m = (t = this.data.mediaData) == null ? void 0 : t[0]) == null ? void 0 : m.type) === "Video" ? this.renderVideoPlane() : ((a = (o = this.data.mediaData) == null ? void 0 : o[0]) == null ? void 0 : a.type) === "Image" && this.renderImagePlane();
      else {
        L(this.five);
        const s = this.position.map(E);
        (e = (r = this.tag3DContentSvelte) == null ? void 0 : r.dispose) == null || e.call(r);
        const p = document.createElement("div");
        p.classList.add("tag-media-container");
        const h = f({ mode: "front", cornerPoints: s, container: p }, this.config.tag3DConfig), l = this.computeRenderType() === "BehindDom" || h.mode === "behind" ? "behind" : "front", d = new k(y(f({}, h), { mode: l })), u = this.computeNormal();
  ...
  renderVideoPlane() {
    ...
    if (!t)
      return;
    const m = this.currentVisible, o = (() => !!(this.mediaPlane && !m))(), a = (() => !!(!this.mediaPlane && m))(), r = (() => !!(this.mediaPlane && this.mediaPlane.src !== t))();
    if ((o || r) && this.mediaPlane && (this.plugin.imagePlaneGroup.remove(this.mediaPlane), this.mediaPlane.dispose(), this.mediaPlane.removeFromParent(), this.mediaPlane = void 0), a || r) {
      const s = this.position.map(S), p = new j(t, s, {
      ...
      p.onVideoReady = (l) => {
        l.addEventListener("play", () => this.plugin.mediaStore.set({ currentMediaElement: p.videoInstance }));
      };
      const h = (l) => (this.five.on("renderFrame", l), () => this.five.off("renderFrame", l));
      p.initialRenderHooks(h), this.mediaPlane = p, this.play = () => p.play(), this.pause = () => p.pause(), this.plugin.imagePlaneGroup.add(this.mediaPlane);
    }
    this.five.needsRender = !0;
  }
  renderImagePlane() {
    ...
    if (!t)
      return;
    const m = this.position.map(S), o = this.currentVisible, a = (() => !!(this.mediaPlane && !o))(), r = (() => !!(!this.mediaPlane && o))(), e = (() => !!(this.mediaPlane && this.mediaPlane.src !== t))();
    (a || e) && this.mediaPlane && (this.plugin.imagePlaneGroup.remove(this.mediaPlane), this.mediaPlane.dispose(), this.mediaPlane.removeFromParent(), this.mediaPlane = void 0), (r || e) && (this.mediaPlane = new N(t, m, { objectFit: this.data.objectFit }), this.getConfig().clickable !== !1 && this.plugin.domEvents.addAutoBindEventListener(
      this.mediaPlane,
      "click",
      (s) => {
