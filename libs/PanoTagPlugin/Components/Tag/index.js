...
import sA from "./AudioTag/index.js";
...
function QA(i) {
  let A, t, e, n, l, d, g, m, o, s, f, u, b, h, B, E, T;
  const Y = [
    vA,
    MA,
    DA,
  ...
  function J(r, p) {
    ...
    9 && (m = null), p & /*tag, contentTypeMap*/
    9 && (o = null), p & /*tag, contentTypeMap*/
    9 && (s = null), n == null && (n = !!(["Text"].includes(
      /*tag*/
      r[0].contentType
    ) || ["Text"].includes(
      /*contentTypeMap*/
    ...
    ))), o ? 5 : (s == null && (s = !!(["Panorama"].includes(
      /*tag*/
      r[0].contentType
    ) || ["Panorama"].includes(
      /*contentTypeMap*/
  ...
  return ~(f = J(i, -1)) && (u = C[f] = Y[f](i)), {
    ...
    m(r, p) {
      F(r, A, p), x(A, t), x(t, e), ~f && C[f].m(e, null), i[16](A), B = !0, E || (T = eA(
        A,
        "click",
        /*click_handler_1*/
        i[17],
    ...
    p(r, p) {
      var a;
      let y = f;
      f = J(r, p), f === y ? ~f && C[f].p(r, p) : (u && (AA(), w(C[y], 1, 1, () => {
        C[y] = null;
      }), $()), ~f ? (u = C[f], u ? u.p(r, p) : (u = C[f] = Y[f](r), u.c()), k(u, 1), u.m(e, null)) : u = null), (!B || p & /*tag*/
      1) && Q(
        e,
        "unfolded",
        /*tag*/
...
function EA(i) {
  ...
  return t = m(i, -1), e = g[t] = d[t](i), {
    ...
    m(o, s) {
      g[t].m(o, s), F(o, n, s), l = !0;
    },
    p(o, [s]) {
      let f = t;
      t = m(o, s), t === f ? g[t].p(o, s) : (AA(), w(g[f], 1, 1, () => {
        g[f] = null;
      }), $(), e = g[t], e ? e.p(o, s) : (e = g[t] = d[t](o), e.c()), k(e, 1), e.m(n.parentNode, n));
    },
    i(o) {
      l || (k(e), l = !0);
    },
...
function TA(i, A, t) {
  let e, n, l, d, g, m, { tag: o } = A, { hooks: s } = A, { rendererMap: f = /* @__PURE__ */ new Map() } = A, { contentTypeMap: u = /* @__PURE__ */ new Map() } = A, { state: b } = A, { mediaStore: h } = A, { temporaryState: B } = A;
  q("hooks", s), q("mediaStore", h);
  let E, T;
  function Y(a) {
    a ? s.emit("exposure", { id: d, type: "start" }) : s.emit("exposure", { id: d, type: "end" });
  }
  function C(a, z, H) {
    var G, I;
  ...
  const r = (a) => s.emit("click", { event: a, target: "TagContent", tag: o });
  function p(a) {
    X[a ? "unshift" : "push"](() => {
      o.contentDom = a, t(0, o);
    });
  ...
  const y = (a) => {
    o.entryFromModel && dA(o.five.state.mode) ? (a.stopPropagation(), o.find({ targetMode: "Panorama" })) : s.emit("click", { event: a, target: "TagContent", tag: o });
  };
  return i.$$set = (a) => {
    "tag" in a && t(0, o = a.tag), "hooks" in a && t(1, s = a.hooks), "rendererMap" in a && t(2, f = a.rendererMap), "contentTypeMap" in a && t(3, u = a.contentTypeMap), "state" in a && t(6, b = a.state), "mediaStore" in a && t(7, h = a.mediaStore), "temporaryState" in a && t(8, B = a.temporaryState);
  }, i.$$.update = () => {
