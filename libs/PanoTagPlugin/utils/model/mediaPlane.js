...
var S = (c, h, e) => h in c ? H(c, h, { enumerable: !0, configurable: !0, writable: !0, value: e }) : c[h] = e;
var r = (c, h, e) => (S(c, typeof h != "symbol" ? h + "" : h, e), e);
...
class z extends C {
  constructor(e, i, t) {
    ...
    let a = i;
    if (n) {
      const s = E(i).multiplyScalar(F.Z_FIGHTING_OFFSET);
    ...
    x(e).then(({ texture: s, transparent: u }) => {
      ...
      ), l = b(...d), m = d.map((y) => y.clone().sub(l)), f = new B(m);
...
class D extends C {
  ...
  constructor(e, i, t) {
    ...
    this.cornerPoints = i, this.src = e, this.buttonSrc = (() => o === "withText" ? _ : o === "withoutText" ? P : typeof o == "string" ? o : P)(), this.videoCoverSrc = n, this.objectFit = a, this.videoTextureMap = u, this.ImageTextureMap = M, this.domEvents = d, this.position.copy(b(...i)), this.videoCoverSrc && s ? this.addCoverMesh().then(() => this.addButtonMesh()) : this.addVideoMesh().then(() => {
    ...
    return v(this, null, function* () {
      ...
      const e = yield (() => v(this, null, function* () {
        ...
        if (!this.videoCoverSrc)
          return;
        const { texture: i, transparent: t } = yield this.getImageTexture(this.videoCoverSrc), n = new I.MeshBasicMaterial({ transparent: !1, map: i }), a = g(this.objectFit, this.cornerPoints, i.image.width / i.image.height), o = new T(a, n);
  ...
  addButtonMesh() {
    return v(this, null, function* () {
      ...
      const e = yield (() => v(this, null, function* () {
        ...
        const i = (f = (m = this.videoMesh) == null ? void 0 : m.geometry.points[0].distanceTo(this.videoMesh.geometry.points[3])) != null ? f : 1 / 0, t = (y = (p = this.coverMesh) == null ? void 0 : p.geometry.points[0].distanceTo(this.coverMesh.geometry.points[3])) != null ? y : 1 / 0, n = this.cornerPoints[0].distanceTo(this.cornerPoints[3]), o = Math.min(i, t, n) / n * 0.3, { texture: s, transparent: u } = yield this.getImageTexture(this.buttonSrc), M = g("contain", this.cornerPoints, s.image.width / s.image.height), d = new T(M, new L(s));
