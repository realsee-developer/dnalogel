...
function pi(o, i, t) {
  ...
  const k = {}, d = {}, y = {};
  i.contentTypeConfig && Object.entries(i.contentTypeConfig).forEach(([r, p]) => {
    var O, W;
    ...
    if (!s[e]) {
      if (m.length === 0 && (s[e] = p), m.length === 1) {
        const [n] = m;
        (o.contentType === n || n === "Any") && (s[e] = p);
      }
      if (m.length === 2) {
        const [n = "Any", u = "Any"] = m;
        n === "Mixin" && o.contentType === u && (s[e] = p), (o.stickType === n || n === "Any") && (o.contentType === u || u === "Any") && (s[e] = p);
      }
      if (m.length === 3) {
        const [n = "Any", u, w] = m;
        if (u === "Audio" && o.contentType === "Audio") {
          const L = o;
          (L.stickType === n || n === "Any") && L.data.appearance === w && (s[e] = p);
        }
      }
    }
  });
  ...
  I(d).forEach(([r, p]) => {
    q.forEach((e) => {
      (r === "PanoramaLike" && R(e) || r === "ModelLike" && S(e)) && (f[e] = l({}, M, ...Object.values(p), h, { _isMerged: !0 }));
    });
  }), I(y).forEach(([r, p]) => {
    const e = f[r];
    f[r] = l({}, M, e, ...Object.values(p), h, { _isMerged: !0 });
  });
  const T = _(F({}, G), { configWithFiveMode: f });
  return P(T), Object.values(f).forEach((r) => P(r)), T._isMerged = !0, T;
}
export {
  pi as calculateTagConfig
};
