...
function P(o) {
  return c(this, null, function* () {
    const e = yield g(o.outlines), r = o.computed_data.bounding, l = o.computed_data.floor_datas.map(d), n = o.computed_data.entrance ? v(o.computed_data.entrance) : null;
    return {
      outlines: e,
      entrance: n,
      bounding: r,
      floorDatas: l,
      observers: o.computed_data.observers.map(x)
    };
  });
}
function y(o, e, r) {
