...
var u = (d, n, t) => n in d ? F(d, n, { enumerable: !0, configurable: !0, writable: !0, value: t }) : d[n] = t, p = (d, n) => {
  for (var t in n || (n = {}))
...
import { CAMERA_IMAGE as T } from "../Assets/camera.js";
import { omit as _ } from "../../shared-utils/filter.js";
import { FLOOR_PLAN_ATTACHED_TO as I } from "../constant.js";
...
import { replaceStaticPrefix as H } from "../../shared-utils/url/replace-static-prefix.js";
...
class Ji extends M {
  constructor(t, i) {
    ...
    i != null && i.selector && (this.selector = i.selector, console.warn("不推荐继续使用 params.selector 配置父容器，请使用 appendTo 方法")), this.defaultMissingFloorConfig = {
      imageURL: H(i == null ? void 0 : i.staticPrefix, z),
      imageWidth: 200,
      imageHeight: 120,
    ...
    }, s = i ? _(i, ["selector", "scale"]) : {}, r = p(p({}, e.missingFloorConfig), s.missingFloorConfig), a = f(p(p({}, e), s), { missingFloorConfig: r });
  ...
  render(t) {
    ...
    this.app = new L({ target: this.container, intro: !0, props: i });
  }
}
export {
  Ji as Controller
