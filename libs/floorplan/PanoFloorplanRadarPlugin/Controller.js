...
var l = (o, e, t) => new Promise((i, r) => {
  ...
  }, m = (a) => a.done ? i(a.value) : Promise.resolve(a.value).then(p, h);
...
import { FLOORPLAN_DEFAULT_IMAGE as E } from "../../shared-utils/url/defaultUrls.js";
import { replaceStaticPrefix as k } from "../../shared-utils/url/replace-static-prefix.js";
...
class li extends O {
  constructor(t, i) {
    ...
    const r = {
      ...
      highlightEnable: !1,
      cameraImageUrl: D,
      missingFloorImageUrl: k(i == null ? void 0 : i.staticPrefix, E)
  ...
  load(t, i, r = !0) {
    return l(this, null, function* () {
      ...
      const h = JSON.parse(JSON.stringify(t)), m = p(h) ? h.data : h, a = this.data;
      this.data = yield b(m), this.hooks.emit("dataLoaded", this.data), this.hooks.emit("dataChange", this.data, a), i && this.updateState(i, r), this.render();
    });
  }
  show() {
