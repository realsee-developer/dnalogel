...
var r = (i, e, o) => e in i ? s(i, e, { enumerable: !0, configurable: !0, writable: !0, value: o }) : i[e] = o;
var t = (i, e, o) => (r(i, typeof e != "symbol" ? e + "" : e, o), o);
import n from "./RoomLabelItems.js";
...
class g {
  ...
  render() {
    ...
    if (this.wrapper) {
      ...
      this.app ? this.app.$set({ five: this.five, roomLabels: this.roomLabels }) : this.app = new n({
