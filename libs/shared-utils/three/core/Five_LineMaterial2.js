...
var c = (n, t, i) => t in n ? o(n, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : n[t] = i;
var a = (n, t, i) => (c(n, typeof t != "symbol" ? t + "" : t, i), i);
...
class l extends r.ShaderMaterial {
  // to be set by renderer
  constructor(i) {
    super({
      uniforms: r.UniformsUtils.clone(s.uniforms),
