...
class V extends M {
  constructor(e, t) {
    ...
    s(this, "actionIfNoIntersection", "virtualPoint");
    s(this, "plane");
    ...
    s(this, "updateByNdcPosition", (e) => {
      ...
      if (this.actionIfNoIntersection === "virtualPoint") {
        ...
        return n.face = new p.Face3(0, 0, 0, (l = (a = this.lastIntersection) == null ? void 0 : a.face) == null ? void 0 : l.normal), n.isVirtual = !0, this.lastIntersection = n, this.updatePointSelectorHelperIntersect(n), !0;
    ...
    s(this, "mousePositionToNdcPosition", (e) => {
      ...
      if (!t)
        return null;
      const { top: o, left: h, width: a, height: l } = t.getBoundingClientRect(), { clientX: n, clientY: c } = e;
      return {
        x: (n - h) / a,
        y: 1 - (c - o) / l
      };
    ...
    this.five = e, this.config = u(u({}, this.config), t), this.actionIfNoIntersection = (l = (a = t == null ? void 0 : t.actionIfNoIntersection) != null ? a : t == null ? void 0 : t.actionIfNoModelUnderMouse) != null ? l : "virtualPoint";
    ...
    this.pointSelectorHelper = new H(this.five, v(u({}, t == null ? void 0 : t.helper), {
      magnifierParams: u(u({}, h), (c = t == null ? void 0 : t.helper) == null ? void 0 : c.magnifierParams)
