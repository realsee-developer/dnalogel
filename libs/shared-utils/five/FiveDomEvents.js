...
var D = (h, e, t) => e in h ? j(h, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : h[e] = t, L = (h, e) => {
  for (var t in e || (e = {}))
    P.call(e, t) && D(h, t, e[t]);
  if (W)
    for (var t of W(e))
      V.call(e, t) && D(h, t, e[t]);
  return h;
}, G = (h, e) => F(h, R(e));
var a = (h, e, t) => (D(h, typeof e != "symbol" ? e + "" : e, t), t);
import { getObjectVisible as T } from "../three/getObjectVisible.js";
import { calculateThreeMouse as B } from "./calculateThreeMouse.js";
import { getFiveModel as X } from "./getFiveModel.js";
import { THREERaycaster as N } from "../three/core/Raycaster.js";
class z {
  constructor(e, t) {
    a(this, "_five");
    /**
    ...
    a(this, "notify", (e) => {
      ...
      const l = [], c = () => {
        if (!o)
          return !1;
        const r = o.slice(1);
        return r[0] ? this.notify(G(L({}, e), { object: r[0].object, intersects: r })) : !1;
      };
      let v = n;
        ...
        if (x)
          for (const [S, E] of x) {
            ...
            if (E.skipPano && u) {
              ...
              if (g && ((m = this.five.observers[this.five.panoIndex].accessibleNodes) != null && m.some(($) => {
                var k;
                const M = (k = this.five.works.getResolvedObserver({
                  workCode: this.five.state.workCode,
                  panoIndex: $
                })) == null ? void 0 : k.standingPosition;
                return (M == null ? void 0 : M.distanceTo(g)) < 0.3;
              })))
                continue;
            }
            if (((O = this.config) != null && O.noEmitWhenHide || E != null && E.noEmitWhenHide) && !T(r))
              continue;
            if (p = !0, t === "hover") {
              if (r._hovered)
                continue;
              r._hovered = !0;
              for (const g of (H = this.boundObject.hover) != null ? H : [])
