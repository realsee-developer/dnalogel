  ...
  constructor(e, t) {
    ...
    r(this, "animate", () => {
      ...
      if (n !== this._cameraCache && (this._cameraCache = n, this.camera.copy(this.five.camera)), this.renderer.render(this.scene, this.camera), !this.domInited) {
        const o = (s = this.five.getElement()) == null ? void 0 : s.parentElement;
        o && (this.canvasWrapper = document.createElement("div"), this.canvasWrapper.classList.add("five-puppet"), this.canvasWrapper.style.position = "absolute", this.canvasWrapper.style.pointerEvents = "none", this.canvasWrapper.style.left = "0", this.canvasWrapper.style.top = "0", this.canvasWrapper.style.zIndex = `${(h = (c = this.params) == null ? void 0 : c.zIndex) != null ? h : 1}`, this.canvasWrapper.appendChild(this.renderer.domElement), o.appendChild(this.canvasWrapper), this.domInited = !0);
      }
    });
    r(this, "stopAnimate", () => {
