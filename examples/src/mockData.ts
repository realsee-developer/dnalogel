...
//
// const workUrl = `/open-works/${spaceType}/${dataCode}/work.json`
// const floorplanServerDataUrl = `/api/@realsee/open-works/${spaceType}/${dataCode}/floorplanServerData.json`
// const modelRoomLabelsUrl = `/api/@realsee/open-works/${spaceType}/${dataCode}/modelRoomLabels.json`
// const modelEntryDoorGuidePluginServerDataUrl = `/api/@realsee/open-works/${spaceType}/${dataCode}/modelEntryDoorGuidePluginServerData.json`
// // 标尺数据
// const roomInfoUrl = `/api/@realsee/open-works/${spaceType}/${dataCode}/roomInfo.json`
// const roomRulesUrl = `/api/@realsee/open-works/${spaceType}/${dataCode}/roomRules.json`
//
