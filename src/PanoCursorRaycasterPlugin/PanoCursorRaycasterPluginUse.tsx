...
import { useFiveEventCallback, useFiveState, useFiveModelReadyState, unsafe__useFiveInstance } from '@realsee/five/react'
...
const PanoCursorRaycasterPluginUse = (props: PanoCursorRaycasterPluginUsePropTypes) => {
  ...
  useFiveEventCallback(
    ...
    () => {
      ...
      console.info('vector3:', pos.point)
      console.info('array: ', [pos.point.x, pos.point.y, pos.point.z])
      // 添加辅助坐标
    ...
    <Box>
      ...
      <Paper sx={{ position: 'fixed', top: '10px', right: '10px', backgroundColor: 'transparent' }}>
        <ButtonGroup size="large" aria-label="large button group" orientation="vertical">
          <Button onClick={handlePointSelect} disabled={fiveModelReadyState !== 'Loaded' || fiveState.mode !== Five.Mode.Panorama}>
            {enableSelect ? OPERATE_OPTIONS.STOP : OPERATE_OPTIONS.START}
          </Button>
