import{r as D,j as A,T as k,G as z,u as E,D as S,p as Z,I as G,b as R}from"./useFetchDatas-0f4c7a72.js";import{g as O}from"./getInitialParamFromUrl-5dd39f79.js";import{as as y,at as N,au as j,av as W,aw as Y,ax as U,ay as f}from"./index-6625bbdd.js";import{M as H,y as Q}from"./Point-d9aab98f.js";import{r as _}from"./uuid-94297524.js";import{B as P}from"./Box-04b0225f.js";import{P as J}from"./Paper-90a14c33.js";import{B as V}from"./Button-6a932be5.js";import"./createTheme-10ac18fc.js";import"./useTheme-3d02eb2b.js";import"./ButtonBase-9901a3a6.js";function F(o,t,i,n=Q.Linear.None){const e=new H(o).to(t,i).easing(n).start();function a(s){e.update(s)&&requestAnimationFrame(a)}return requestAnimationFrame(a),e}var C=(o=>(o.Drawline="Drawline",o.Undo="Undo",o.Exit="Exit",o))(C||{});const w=Symbol("$$PAINT_BRUSH_EVENT$$");function x(o){return o[w]||(o[w]={}),o[w]}function K(o){o[w]||delete o[w]}class X{hasListener(t){const i=x(this);return i&&i[t]&&i[t].length>0}on(t,i,n){const e=x(this);return e[t]||(e[t]=[]),e[t].push([i,n||!1]),()=>this.off(t,i)}once(t,i){return this.on(t,i,!0)}off(t,i){if(t===void 0){K(this);return}const n=x(this);if(n[t]||(n[t]=[]),i===void 0){n[t].length=0;return}let e=0;for(;e<n[t].length&&n[t][e][0]!==i;e++);e<n[t].length&&n[t].splice(e,1)}emit(t,...i){let n=!1;const e=x(this)[t]||[];for(let a of e.slice()){const[s,h=!1]=a,I=s(...i);h&&this.off(t,s),I===!1&&(n=!0)}return n}}const $=`
<style type="text/css">
